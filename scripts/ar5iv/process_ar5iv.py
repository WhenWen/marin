...
for file in ["/juice4/scr4/nlp/crfm/markweb/ar5iv/error/0003/math0003131.html"]:
    ...
    print(f"https://arxiv.org/abs/{letters.group(0)}/{numbers.group(0)}")
    title = "]".join(BeautifulSoup(urlopen(f"https://arxiv.org/abs/{letters.group(0)}/{numbers.group(0)}"), "html.parser").title.string.split("] ")[1:])
    print(title)
