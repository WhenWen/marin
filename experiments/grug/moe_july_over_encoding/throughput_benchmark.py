...
"""Matched d512 throughput gate for coalesced SparseCore Over-Encoding.
...
_WANDB_GROUP = "MOE-OE-JULY-coalesced-sc-throughput-issue-7368"
_BASELINE_RUN_ID = "MOE-JULY-COALESCED-SC-PERF-BASELINE-d512"
    ...
    return ExecutorStep(
        ...
        config=GrugMoeLaunchConfig(
            ...
            checkpointer=CheckpointerConfig(
                base_path="/tmp/moe-oe-coalesced-sc-throughput-7368",
                save_interval=None,
                keep=None,
            ),
        ),
...
if __name__ == "__main__":
    executor_main(
        ...
        description="Matched canonical July d512 baseline/OE throughput gate for coalesced SparseCore Over-Encoding.",
        max_concurrent=2,
    )
