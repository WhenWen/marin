...
from experiments.grug.moe_july_over_encoding.normsum_lr050 import build_step
...
def test_normsum_lr050_d512_matches_canonical_july_outside_oe_fields():
    ...
    assert candidate.run_id == "MOE-OE-JULY-NORMSUM-LR050-d512"
    ...
    assert candidate.tracker.group == "MOE-OE-JULY-normsum-lr050-issue-7368"
