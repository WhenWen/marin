...
"""Throughput-qualified two-RMSNorm Over-Encoding Gate 1 at July d512."""
...
_RUN_ID = "MOE-OE-JULY-NORMSUM-SC-GATE1-d512"
_WANDB_GROUP = "MOE-OE-JULY-normsum-sc-gate1-issue-7368"


def build_step() -> ExecutorStep:
    """Build the throughput-qualified d512 two-RMSNorm Gate 1 cell."""
...
if __name__ == "__main__":
    executor_main(
        steps=[build_step()],
        description="Throughput-qualified July d512 two-RMSNorm Over-Encoding Gate 1.",
        max_concurrent=1,
    )
