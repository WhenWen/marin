...
"""Scale the throughput-qualified two-RMSNorm Over-Encoding cell to July d768."""
...
_RUN_ID = "MOE-OE-JULY-NORMSUM-SC-GATE2-d768"
_WANDB_GROUP = "MOE-OE-JULY-normsum-sc-gate2-issue-7368"


def build_step() -> ExecutorStep:
    """Build the canonical July d768 two-RMSNorm Gate 2 cell."""
