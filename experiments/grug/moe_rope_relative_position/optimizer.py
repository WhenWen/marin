...
class RelativeQueryProjectionOptimizer(StrEnum):
    """Optimizer group for the hidden-state relative-query projection."""
...
@OptimizerConfig.register_subclass("grug_moe_rope_relative_position_adamh_v2")
...
@OptimizerConfig.register_subclass("grug_moe_rope_relative_position_muonh_v1")
@dataclass(frozen=True)
class GrugMoeMuonHConfig(OptimizerConfig):
    ...
    coefficient_type: CoefficientType = "quintic"
    relative_query_projection_optimizer: RelativeQueryProjectionOptimizer = RelativeQueryProjectionOptimizer.MUONH
    ...
    def create_mask(self, params):
        ...
        def mask_fn(param, path):
            ...
            if (
                ...
                return "adam"
            if (
                path_lower.endswith(".w_r")
                and self.relative_query_projection_optimizer == RelativeQueryProjectionOptimizer.ADAM
            ):
                return "adam"
