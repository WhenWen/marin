...
from experiments.grug.moe_yoco_kv_reuse.adamh import scale_by_adamh
...
@OptimizerConfig.register_subclass("grug_moe_yoco_kv_reuse_adamh_v1")
...
@OptimizerConfig.register_subclass("grug_moe_yoco_kv_reuse_muonh_v1")
@dataclass(frozen=True)
