...
SINGLE_TPU_V4_16 = ResourceConfig(num_tpu=1, tpu_type="TPU-v4-16", strategy="STRICT_PACK")
...
TPU_V4_16_STRICT_PACK = ResourceConfig(num_tpu=8, tpu_type="TPU-v4-16", strategy="STRICT_PACK")
