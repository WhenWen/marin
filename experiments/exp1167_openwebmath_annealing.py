...
owm_tokenized = default_tokenize(
    "openwebmath-crawl",
    "gs://marin-us-central2/scratch/nfliu/text/openwebmath_unique_100M_passing_minhash_against_fineweb_edu/",
...
owm_cooldown_ablation = default_quality_ablation(
    owm_tokenized,
    cooldown_config,
)
